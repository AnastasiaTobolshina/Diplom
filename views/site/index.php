...
<div class="site-index">
                    ...
                    <div class="swiper">
                      ...
                      <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="swiper-inner" data-bgimage="url(/account-dist/images/slider/1.webp)">
                                ...
                                <img src="/account-dist/images/misc/flowers-crop.webp" class="w-30 absolute bottom-0 start-0 sw-anim" alt="">
                            </div>
                        </div>

                        <div class="swiper-slide">
                            <div class="swiper-inner" data-bgimage="url(/account-dist/images/slider/2.webp)">
                                <div class="sw-caption relative z-1000">
                                    <div class="container">
                                        <div class="row gx-5 align-items-center">
            ...
            <!-- <section>
                <div class="container relative">
                    <img src="/account-dist/images/misc/leaf.webp" class="absolute top-0 end-0 w-10 anim-up-down sm-hide" alt="">
                    <div class="row g-4 gx-5 align-items-center">
                            ...
                            <div class="relative">
                                <div class="row g-4 z-1000">
                                    <div class="col-6">
                                        ...
                                        <img src="/account-dist/images/misc/11.webp" class="img-fluid rounded-10px mb-4 w-70 ms-30 wow fadeInLeft" data-wow-delay=".0s" alt="">
                                        <img src="/account-dist/images/misc/3.webp" class="img-fluid rounded-10px wow fadeInUp" data-wow-delay=".1s" alt="">
                                    </div>
                                    <div class="col-6">
                                        <img src="/account-dist/images/misc/10.webp" class="img-fluid rounded-10px mb-4 wow fadeInDown" data-wow-delay=".2s" alt="">
                                        <img src="/account-dist/images/misc/8.webp" class="img-fluid rounded-10px w-70 wow fadeInRight" data-wow-delay=".3s" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            ...
                            <h2 class="wow fadeInUp">Transform Your<span class="d-block mt-3 alt-font fw-500 fs-64 id-color-2">Mental Health</span></h2>
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-xl-5">
                                    <div class="me-4">
                                        <h3 class="fw-bold mb-1">Excellent</h3>
                                        <div class="de-rating-ext fs-15">
                                            ...
                                            <img src="/account-dist/images/misc/trustpilot-invert.webp" class="w-100px" alt="">
                                        </div>
                                    </div>
                                </div>
            ...
            <!-- <section class="text-light section-dark jarallax">
                <img src="/account-dist/images/background/3.webp" class="jarallax-img" alt="">
                <div class="container">
                    <div class="row g-4 gx-5 relative z-index-1000">
                        <div class="col-lg-2 offset-lg-1 col-sm-4 text-center">
                            <img src="/account-dist/images/team/2.webp" class="img-fluid circle wow scaleIn" alt="">
                            <h5 class="mt-3 mb-0">Jeffery Mussman</h5>
                            <p class="small mb-2">Individual Therapy</p>
                        </div>
                        <div class="col-lg-8 col-sm-8">
                            <p class="mb20 wow fadeInUp fs-32 fw-600 lh-1-3" data-wow-delay=".2s">Mindthera is exceptional! Their psychologists are highly professional and caring. The atmosphere is welcoming and calming, and the staff provides outstanding support. Thank you, Mindthera, for your excellent service!</p>
                        </div>
                    </div>
                </div>
            </section> -->
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6 offset-lg-3 text-center">
                            ...
                            <p class="lead mb-0 wow fadeInUp">Qui culpa qui consequat officia cillum quis irure aliquip ut dolore sit eu culpa ut irure nisi occaecat dolore adipisicing do pariatur.</p>
                            <div class="spacer-single"></div>
                    ...
                    <div class="row g-4">
                        <div class="col-lg-4 col-sm-6">
                            <div class="relative mb-3">
                                <a href="service-single.html" class="d-block hover mb-3">
                                    <div class="relative overflow-hidden rounded-20px shadow-soft">
                                        ...
                                        <img src="images/services/1.webp" class="img-fluid hover-scale-1-2" alt="">
                                    </div>
                                </a>
                    ...
                    <div class="row g-4">
                        <div class="col-md-3 col-sm-6 mb-sm-30">
                            <div class="de_count fs-15 wow fadeInRight" data-wow-delay=".0s">
                                <h3 class="fs-40"><span class="timer fs-40" data-to="650" data-speed="3000">0</span>+</h3>
                                Довольных клиентов
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-6 mb-sm-30">
                            <div class="de_count fs-15 wow fadeInRight" data-wow-delay=".2s">
                                <h3 class="fs-40"><span class="timer fs-40" data-to="1200" data-speed="3000">0</span>+</h3>
                                Выполненых заказов
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-6 mb-sm-30">
                        ...
                        <div class="col-md-3 col-sm-6 mb-sm-30">
                            <div class="de_count fs-15 wow fadeInRight" data-wow-delay=".6s">
                                <h3 class="fs-40"><span class="timer fs-40" data-to="6" data-speed="3000">0</span>+</h3>
            ...
            <section class="bg-color text-light pt40 pb40">
                <div class="container">
                    <div class="row g-4 align-items-center">
                        ...
                        <div class="col-lg-3">
                            <a class="btn-main bg-color-2" href="contact.html">Book an Appointment</a>
                        </div>
                    </div>
                </div>
            </section>
